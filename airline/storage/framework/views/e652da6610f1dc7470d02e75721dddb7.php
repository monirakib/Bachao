...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="dob-gender-select">
                    <div class="dob">
                        <input type="date" name="date_of_birth" required value="<?php echo e(old('date_of_birth')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="toggle-container">
            <div class="toggle">
                ...
                <div class="toggle-panel toggle-right">
                    <h1>Hello, Cruiser!<br>Welcome to BachaoAirlines.</h1>
    ...
    <video autoplay loop muted plays-inline class="background-clips">
        <source src="<?php echo e(asset('pics/background.mp4')); ?>" type="video/mp4">
    </video>
...
</html><?php /**PATH C:\xampp\htdocs\Bachao\airline\resources\views/auth/login.blade.php ENDPATH**/ ?>